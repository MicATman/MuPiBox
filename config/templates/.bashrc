...
function mupi-update-webinterface() {
	sudo rm -R /var/www/*
	sudo wget -o /var/www/www.zip https://github.com/MicATman/MuPiBox/raw/main/AdminInterface/release/www.zip
...
function mupi-info() {
	...
	echo -e "  ${BCyan}Latest-Version:   ${BIPurple}$(curl --max-time 5 -s https://raw.githubusercontent.com/MicATman/MuPiBox/main/version.json | jq -r .release.stable[-1].version)${Color_Off}"
	echo -e "${Color_Off}"
...
#mupibox aliases
alias mupi-update-stable='cd; curl -L https://raw.githubusercontent.com/MicATman/MuPiBox/main/update/start_mupibox_update.sh | sudo bash  -s -- stable'
alias mupi-update-beta='cd; curl -L https://raw.githubusercontent.com/MicATman/MuPiBox/main/update/start_mupibox_update.sh | sudo bash  -s -- beta'
alias mupi-update-dev='cd; curl -L https://raw.githubusercontent.com/MicATman/MuPiBox/main/update/start_mupibox_update.sh | sudo bash  -s -- dev'
